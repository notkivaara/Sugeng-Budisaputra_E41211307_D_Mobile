package com.example.acara30_shared_preference;
...
//    Mengembalikan nilai dari key KEY_USER_TEREGISTER berupa string
    ...
    /* Deklarasi Edit Preferences dan mengubah data
    * yang memeiliki KEY_PASS_TEREGISTER dengan parameter password*/
    ...
    * yang memiliki key KEY_USERNAME_SEDANG_LOGIN dengan parameter username */
    ...
    /* Mengmebalikan nilai dari key KEY_USERNAME_SEDANG_LOGIN berupa String*/
    public static String getLoggedInUsera(Context context){
        return getSharedPreference(context).getString(KEY_USERNAME_SEDANG_LOGIN,"");
    }

    /*Deklarasi Edit Prefrences dan mengubah data
